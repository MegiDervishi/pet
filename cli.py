...
from pet.tasks import PROCESSORS, load_examples, load_examples_quad_train, UNLABELED_SET, TRAIN_SET, DEV_SET, TEST_SET, METRICS, DEFAULT_METRICS
...
def main():
    ...
    # Required parameters
    parser.add_argument("--method", default='pet', required=True, choices=['pet', 'ipet', 'sequence_classifier'],
                        help="The training method to use. Either regular sequence classification, PET or iPET.")
    parser.add_argument("--data_dir", default='../squad', type=str, required=False,
                        help="The input data dir. Should contain the data files for the task.")
    parser.add_argument("--model_type", default='distilbert', type=str, required=False, choices=MODEL_CLASSES.keys(),
    ...
    parser.add_argument("--task_name", default='iquad', type=str, required=False, choices=PROCESSORS.keys(),
                        help="The name of the task to train/evaluate on")
    parser.add_argument("--output_dir", default='./results_meg', type=str, required=False,
    ...
    parser.add_argument('--pet_gradient_accumulation_steps', type=int, default=8,
    ...
    parser.add_argument("--pet_max_steps", default=250, type=int,
    ...
    parser.add_argument('--sc_gradient_accumulation_steps', type=int, default=8,
    ...
    parser.add_argument("--sc_max_steps", default=5000, type=int,
    ...
    if args.task_name == 'fquad' or args.task_name == 'iquad':
        train_data, unlabeled_data = load_examples_quad_train(
            args.task_name, args.data_dir, TRAIN_SET, num_examples=train_ex, num_examples_per_label=train_ex_per_label,
            num_examples_unlabel=args.unlabeled_examples) 
