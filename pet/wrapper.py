...
from transformers import InputExample, AdamW, get_linear_schedule_with_warmup, PreTrainedTokenizer, BertForMaskedLM, \
    ...
    GPT2Config, GPT2LMHeadModel, GPT2Tokenizer, DistilBertConfig, DistilBertForSequenceClassification, \
    DistilBertTokenizer, DistilBertForMaskedLM, CamembertConfig, CamembertForSequenceClassification, \
